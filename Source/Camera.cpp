...
namespace
{
	constexpr float near_clip{10.f};
	constexpr float far_clip{10000.f};
	...
	constexpr float run_speed{900.f};
...
void LV::Camera::set(const glm::fvec3& position, const glm::fvec2& axes, float fov)
{
	::position = position;
	::axes = axes;
	::fov = fov;
